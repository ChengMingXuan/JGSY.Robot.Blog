var App = function () {
  ...
  //      });
	...
	var handleRaty = function () {
        $.fn.raty.defaults.path = 'Cloud/js/jquery-raty/img';
	...
	var handleTimeline = function () {
		createStoryJS({
			...
			width:		'100%',
			height:		'600',
            source:		'Cloud/js/timelinejs/example_json.json',
			embed_id:	'my-timeline',
			debug:		true,
			css:        'Cloud/js/timelinejs/css/timeline.css',     
            js:         'Cloud/js/timelinejs/js/timeline-min.js'    
		});
	}
	/*-----------------------------------------------------------------------------------*/
	/*	Handle Slidernav
	...
	var handleSliderNav = function () {
		...
		$('#address-book .slider-content ul li ul li a').click(function(e){
			...
			//Set the image
			$('#contact-card .headshot img').attr('src', 'Cloud/img/addressbook/'+img_id+'.jpg');
	...
	var handleThemeSkins = function () {
        ...
        var setSkin = function (color) {
            $('#skin-switcher').attr("href", "Cloud/css/themes/" + color + ".css");
