#pragma checksum "E:\2018blog\JGSY.Robot.Blog\jgsy.robot.blog\Areas\MongoDB\Views\MongoDB\MongoDB3.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ab075b27c4b298a7c48c13791a6317c54ef401cb"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ab075b27c4b298a7c48c13791a6317c54ef401cb", @"/Areas/MongoDB/Views/MongoDB/MongoDB3.cshtml")]
   ...
   E:\software\MongoDB>mongo 127.0.0.1:27017/blog
    ...
    <pre>
    解决方式:配置 
    ① auth=true mongodb安装目录bin下有自己添加的mongo.config配置文件 
    ② 安装服务时添加  --auth  开启认证
</pre>
    <pre>
    ①
    ...
    重新安装mongodb服务A: &gt; mongod --auth --bind_ip 127.0.0.1 --lo");
            WriteLiteral(@"gpath ""E:\software\MongoDB\Server\data\log\mongodb.log"" 
    ...
    重新安装mongodb服务 A: &gt; mongod --auth --bind_ip 127.0.0.1 --logpath ""E:\software\MongoDB\Server\data\log\mongodb.log""
                                       --logappend --dbpa");
            WriteLiteral(@"th ""E:\software\MongoDB\Server\data\db"" --port 27017 
                                       --serviceName ""mongodb"" --serviceDisplayName ""mongodb"" --install
    启动mongodb服务 &gt;  net start mongodb     
    创建用户名、密码、设置角色和认证 
    ...
    •dbAd");
            WriteLiteral(@"min：允许用户在指定数据库中执行管理函数，如索引创建、删除，查看统计或访问system.profile
    ...
    clusterMa");
            WriteLiteral(@"nager：授予管理和监控集群的权限，A user with this role can access the config and local databases, which are used in sharding and replication, respectively.
