#pragma checksum "E:\2018blog\JGSY.Robot.Blog\jgsy.robot.blog\Areas\MongoDB\Views\MongoDB\MongoDB3.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2cf53573a52f6c558571ea3fd9b30c4af5f49123"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2cf53573a52f6c558571ea3fd9b30c4af5f49123", @"/Areas/MongoDB/Views/MongoDB/MongoDB3.cshtml")]
    ...
    ① auth=true mongodb安装目录bin下有自己添加的mongo.config 方案1)配置文件 、方案2) yaml 
                 ****************重新 install 的时候 清空dbpath、logpath目录下的所有文件 *************************
                     方案1)
                        bin 创建mongod.config
            ");
            WriteLiteral(@"            dbpath=E:\software\MongoDB\Server\data\db
...
");
            EndContext();
            BeginContext(3770, 5054, true);
            WriteLiteral(@"            &gt;   db.auth(""admin"",""P@ssw0rd"")
    ...
    退出后登录（默认test库 或指定）   &gt;    mongo --po");
            WriteLiteral(@"rt 27017 -u ""admin"" -p ""P@ssw0rd"" --authenticationDatabase ""admin""
...
<div class=""col-lg-12 col-md-12 col-sm-12"">
    ...
    <h5><a href=""ht");
            WriteLiteral(@"tps://blog.csdn.net/hkyw000/article/details/54411230"">mongodb yaml 配置方式</a></h5> 
...
<div class=""col-lg-12 col-md-12 col-sm-12"">
    ...
    <h5>登录  mongo admin --port 27017 -u ""admin"" -p ""P@ssw0rd"" --au");
            WriteLiteral(@"thenticationDatabase ""admin""  </h5>
