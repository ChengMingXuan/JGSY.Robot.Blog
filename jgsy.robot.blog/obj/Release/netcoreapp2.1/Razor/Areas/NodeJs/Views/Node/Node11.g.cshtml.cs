#pragma checksum "E:\2018blog\JGSY.Robot.Blog\jgsy.robot.blog\Areas\NodeJs\Views\Node\Node11.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4c97e8caa61da0bcb3797ad3811f3ce5a2568425"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4c97e8caa61da0bcb3797ad3811f3ce5a2568425", @"/Areas/NodeJs/Views/Node/Node11.cshtml")]
    public class Areas_NodeJs_Views_Node_Node11 : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "92cbc213d84a4ebfb7ad75938c2f619c", async() => {
            }
            );
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "0464309df138444da6b148ef6c61c46c", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "47b8457f6e3b46f1877adfc09f206f9b", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "82b807db31384285a5f5430327edf632", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
     ...
     ");
        ...
        <pre> 
         ...
         执行结果成功
            ...
            WriteLiteral(@"d now it is to install the new keys
      ...
      ");
            WriteLiteral(@"          -A INPUT -p tcp --dport 80 -j ACCEPT
            ...
            保存
            执行防火墙规则
            sudo iptables-restore < /etc/ip");
            WriteLiteral(@"tables.up.rules 
        ...
        <h5><a href=""https://blog.csdn.net/u010458114/article/details/70161486"" target=""_blank"">Ubuntu ssh免密参考</a></h");
            WriteLiteral(@"5>
        ...
        nvm管理nodejs版本
            <a href="" https://github.com/creationix/nvm"" target=""_blank""> https://github.com/creationix/nvm</a>
...
date_now=`date +%Y_%m_%d_%");
            WriteLiteral("H%M`\r\nbackFileName=movie_$date_now\r\n\r\ncd backUpFoler\r\nmkdir -p $backFileName\r\n\r\nmongodump -h 127.0.0.1:27018 -d movie -u robot -p robot -o $backFileName\r\n\r\ntar zcvf $backFileName.tar.gz $backFileName\r\n\r\nrm -rf $backFileName\r\n\r\n#添加 上传至远程存储");
            EndContext();
            BeginWriteAttribute("NODE_ENV", "\r\nNODE_ENV=", 29125, "", 29163, 3);
            WriteAttributeValue("", 29136, "$backUpFoler", 29136, 12, true);
            WriteAttributeValue("", 29148, "@", 29148, 1, true);
            WriteAttributeValue("", 29150, "$backFileName", 29150, 13, true);
            EndWriteAttribute();
            BeginContext(29163, 29027, true);
...
sudo apt-get install mysql-server mysql-client
   ...
   <pre>
     ...
     ");
            WriteLiteral(@"       cd existing_git_repo
            git remote add origin https://gitee.com/JGSY/jgsy.movie.git
            git push -u origin master
        ...
        本地 client连接服务器创建");
            WriteLiteral(@"并执行 第一次 加setup 初始化目录层次
        ...
        ecosystem.json
         {
            ...
            ""deploy"": {
              ""production"": {
                ...
                ""env"":{
                  ""NO");
            WriteLiteral(@"DE_ENV"":""production""
                }
              }
            }
          }
          服务器上 生成三个文件
           ...
           客户端签入 ecosystem.json  再次执行
            git add . && commit -m ""ecosystem.json"" && git push origin master
        ...
        ecosystem.json
         {
            ...
            ""deploy"": {
              ""production"": {
                ...
                ""path"":""/www/website/production"",
   ");
            WriteLiteral(@"             ""ssh_options"":""StrictHostKeyChecking=no"",
                ""post-deploy"":""npm install --register=https://registry.npm.taobao.org && grunt build && pm2 startOrRestart ecosystem.json --env production"", 
                ""env"":{
                  ""NODE_ENV"":""production""
                }
        ...
        由于我这里没有使用bower统一管理路径 自定js css img 等静态资源放在了public下 
            ...
            upstream website {
                ...
                server {
                    listen  80;
   ");
            WriteLiteral(@"               #server_name 119.29.104.251;
                   server_name movie.dncblocks.com;
...
<h5><a href=""https://docs.mongodb.com/manual/tutorial/install-mongodb-on-ubuntu/"" target=""_blank"">ins");
            WriteLiteral(@"tall-mongodb-on-ubuntu官网API</a></h5>
...
•-Q <");
            WriteLiteral(@"字符串> --quotestr=<字符串> 引用代表字符串
•-R --restricted 限制模式
•-S --smooth 按行滚动而不是半屏
...
如果需要复制／剪贴多行或者一行中的一部分，先将光标移动到需要复制／剪贴的文本的开头，
            ...
            ，用Alt+6来复制，Ctrl+K来剪贴。若");
            WriteLiteral(@"在选择文本过程中要取消，只需要再按一次Ctrl+6。
    ...
    <pre>
{
  ...
  ""deploy"" : {
    ""production"" : {
      ""user"" : ""robot"",
      // Multi host is possible, just by passing IPs/ho");
            WriteLiteral(@"stname as an array
      ""host"" : [""119.29.104.251""],
      // Branch
      ""ref""  : ""origin/master"",
...
1. directory
如果指定参数direc");
            WriteLiteral(@"toryperdb =yes，则会每个db一个目录。其中包含该db的所有数据文件
directoryPerDB: true
...
insert query update delete getmore command dirty  used flushes vsize  res qrw arw net_in net_out conn      set repl                time
    ...
    *0    16     *0     *0   ");
            WriteLiteral(@"    2     7|0  0.0% 80.0%       0  262G 201G 0|0 0|0  15.1k   57.9k  125 test222  PRI Dec 26 19:50:56.199
...
2017-12-26T19:53:12.912+0800    connected to: 主机名:端口号
               ...
               ");
            WriteLiteral(@"  admin.system.version      0ms     0ms      0ms                             
...
> db.oplog.rs.find()
{ ""ts"" : Timestamp(1513290869, 119), ""t"" : NumberLong(0), ""h"" : NumberLong(""-164732681870941527""), ""v"" : 2, ""op"" : """);
            WriteLiteral(@"d"", ""ns"" : ""xxxx"", ""fromMigrate"" : true, ""o"" : { ""_id"" : ObjectId(""xxxx"") } }
...
source: 10.33.57.174:24000
  ...
  ");
            WriteLiteral(@"      0 secs (0 hrs) behind the primary 
...
db.Stats()：Stats 命令，或外壳程序中的 db.stats() 返回一份针对存储使用情");
            WriteLiteral(@"况和数据卷的文档。 dbStats 显示了存储的使用量、包含在数据库中的数据的总量以及对象、集合和索引计数器。
...
create index id_u");
            WriteLiteral(@"ser_id_asc on users(user_id);
...
db.us");
            WriteLiteral(@"ers.distinct(""status"")
...
responseLength 如果过大，说明返回的结果集太大了");
            WriteLiteral(@"，这时要看是否只需要必要的字段。
...
");
            WriteLiteral(@"    解决失败  sudo service mongod start 命令不可用 这种启动可以sudo systemctl start mongodb
    ...
    1) sudo apt-key adv --keyserver hkp://keyserver.ubuntu.com:80 --recv 9DA31620334BD75D9DCB49F368818C72E");
            WriteLiteral(@"52529D4
    2) echo ""deb [ arch=amd64,arm64 ] https://repo.mongodb.org/apt/ubuntu xenial/mongodb-org/4.0 multiverse"" | sudo tee /etc/apt/sources.list.d/mongodb-org-4.0.list
    update the list
    ...
    sudo systemctl start mongodb
    sud");
            WriteLiteral(@"o systemctl status mongodb
